...
import { ArrowLeft, ExternalLink, Target, Brain, Calendar, CheckCircle, Lightbulb, TrendingUp, Zap } from 'lucide-react';
        ...
        <div className="pt-48 md:pt-48">
          ...
          <div className="mb-8 p-8 md:p-10 rounded-[48px]" style={{ ...cardStyle, border: `2px solid ${primaryColor}` }}>
            <div className="flex items-center justify-center gap-4 mb-8">
              <h1 className="text-4xl md:text-5xl font-bold" style={{ color: primaryColor }}>FIRSTDAY.LIFE</h1>
            </div>
