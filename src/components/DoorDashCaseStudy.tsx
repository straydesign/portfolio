      ...
      <div className="w-full px-6 md:px-12 max-w-full">
        ...
        <div className="pt-48 md:pt-48">
          ...
          <div className="mb-8 p-8 md:p-10 rounded-[48px]" style={{ ...cardStyle, border: `2px solid ${primaryColor}` }}>
            <h1 className="text-3xl md:text-5xl font-bold mb-4 text-center" style={{ color: primaryColor }}>
              DOORDASH DASHER APP
            </h1>
            <p className="text-lg md:text-xl text-center mb-8 leading-relaxed" style={{ color: textColor, opacity: 0.9 }}>
