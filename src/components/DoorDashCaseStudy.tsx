...
export default function DoorDashCaseStudy({ onBack }: DoorDashCaseStudyProps) {
  ...
  const onPrimaryColor = accentColor === 'bw' ? (theme === 'dark' ? '#000000' : '#ffffff') : '#ffffff';
      ...
      <div className="w-full px-4 md:px-8 max-w-[90rem] mx-auto">
          ...
          <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-4" staggerDelay={0.08}>
            {[
              ...
              <StaggerItem key={label}>
                <div className="p-5 rounded-2xl text-center" style={{ backgroundColor: statBg, border: `1px solid ${primaryColor}15` }}>
        ...
        <AnimateIn direction="up" className="py-16 md:py-24" style={{ borderBottom: divider }}>
          <div className="flex items-center gap-3 mb-6">
            <div className="w-8 h-8 rounded-full flex items-center justify-center" style={{ backgroundColor: primaryColor, color: onPrimaryColor }}>
        ...
        <AnimateIn direction="up" className="py-16 md:py-24" style={{ borderBottom: divider }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
            {['Forgot an item', 'Wrong apartment', 'Drink left in car', 'Accidental tap'].map((item) => (
              <div key={item} className="p-3 rounded-xl text-center" style={{ backgroundColor: statBg }}>
        ...
        <AnimateIn direction="up" className="py-16 md:py-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center mb-8">
            ...
            <div className="text-center p-6 rounded-2xl" style={{ backgroundColor: `${primaryColor}10`, border: `2px solid ${primaryColor}30` }}>
