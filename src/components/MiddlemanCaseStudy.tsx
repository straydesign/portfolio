  ...
  return (
    <div className="min-h-screen">
      <div className="w-full px-4 md:px-8 max-w-[90rem] mx-auto">
        ...
        <NavigableSection id="mm-hero" label="Hero">
        ...
        {/* ── THE PROBLEM ── */}
        <NavigableSection id="mm-problem" label="The Problem">
        <AnimateIn direction="up" className="py-16 md:py-24" style={{ borderBottom: divider }}>
          <TextCard padding="lg">
            <p className="text-[11px] font-bold tracking-[0.2em] uppercase mb-4" style={{ color: '#a1a1a6' }}>
              WHY
            </p>
            <p className="text-xl md:text-3xl leading-relaxed font-bold mb-8" style={{ color: textColor }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="p-4" style={{ backgroundColor: '#000000', border: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        {/* ── THE COMMAND CENTER ── */}
        <NavigableSection id="mm-command-center" label="Command Center">
        <AnimateIn direction="up" className="py-16 md:py-24" style={{ borderBottom: divider }}>
          <TextCard padding="lg">
            <p className="text-[11px] font-bold tracking-[0.2em] uppercase mb-4" style={{ color: '#a1a1a6' }}>
              HOW
            ...
            <p className="text-xl md:text-2xl font-bold mb-6" style={{ color: textColor }}>Walk in. See what matters. Act on it.</p>
        ...
        {/* ── THE PULL LIST ── */}
        <NavigableSection id="mm-pull-list" label="Pull List">
        <AnimateIn direction="up" className="py-16 md:py-24" style={{ borderBottom: divider }}>
          <TextCard padding="lg">
            <p className="text-xs font-bold tracking-widest mb-3 uppercase" style={{ color: primaryColor }}>The Pull List</p>
            <p className="text-xl md:text-2xl font-bold mb-6" style={{ color: textColor }}>Your job is to fill shelves. This tells you exactly what to pull.</p>
            <p className="text-base leading-relaxed mb-10" style={{ color: secondaryTextColor }}>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12">
              <div className="w-full md:w-1/2">
                ...
                />
                <div className="p-3 mt-3" style={{ backgroundColor: '#000000', border: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        {/* ── THE SCHEDULE ── */}
        <NavigableSection id="mm-schedule" label="Schedule">
        <AnimateIn direction="up" className="py-16 md:py-24" style={{ borderBottom: divider }}>
          <TextCard padding="lg">
            <p className="text-xs font-bold tracking-widest mb-3 uppercase" style={{ color: primaryColor }}>The Schedule</p>
            <p className="text-xl md:text-2xl font-bold mb-6" style={{ color: textColor }}>Time is the axis. Today&apos;s truck is the hero.</p>
            <p className="text-base leading-relaxed mb-10" style={{ color: secondaryTextColor }}>
        ...
        {/* ── DESIGN SYSTEM ── */}
        <NavigableSection id="mm-design-system" label="Design System">
        <AnimateIn direction="up" className="py-16 md:py-24" style={{ borderBottom: divider }}>
          <TextCard padding="lg">
            ...
            <p className="text-base mt-3 leading-relaxed mb-10" style={{ color: secondaryTextColor }}>
        ...
        {/* ── INTELLIGENCE LAYER ── */}
        <NavigableSection id="mm-intelligence" label="Intelligence Layer">
        <AnimateIn direction="up" className="py-16 md:py-24" style={{ borderBottom: divider }}>
          <TextCard padding="lg">
        ...
        {/* ── THE HYPOTHESIS ── */}
        <NavigableSection id="mm-hypothesis" label="The Hypothesis">
        <AnimateIn direction="up" className="py-16 md:py-24" style={{ borderBottom: divider }}>
          <TextCard padding="lg">
            <p className="text-[11px] font-bold tracking-[0.2em] uppercase mb-4" style={{ color: '#a1a1a6' }}>
              OUTCOME
            </p>
            <p className="text-xs font-bold tracking-widest uppercase mb-4" style={{ color: primaryColor }}>The Hypothesis</p>
            <p className="text-sm mb-8 leading-relaxed" style={{ color: secondaryTextColor }}>
              Based on workflow analysis — not yet validated with live users
            </p>
            <StaggerContainer className="grid grid-cols-1 md:grid-cols-4 gap-6" staggerDelay={0.1}>
              {[
                ...
                <StaggerItem key={label}>
                  <div className="p-6 text-center" style={{ backgroundColor: '#000000', border: '1px dashed rgba(255,255,255,0.12)' }}>
        ...
        {/* ── DESIGN LANGUAGE ── */}
        <NavigableSection id="mm-design-language" label="Design Language">
        <AnimateIn direction="up" className="py-16 md:py-24" style={{ borderBottom: divider }}>
          <TextCard padding="lg">
        ...
        {/* ── TRADE-OFFS ── */}
        <NavigableSection id="mm-tradeoffs" label="Trade-Offs">
      ...
      <NavigableSection id="mm-next" label="Next Project">
